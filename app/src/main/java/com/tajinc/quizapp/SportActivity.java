...
public class SportActivity extends AppCompatActivity {
    ...
    private TrueFalse[] questions = new TrueFalse[]{
            new TrueFalse(R.string.quest111, true),
            new TrueFalse(R.string.quest112, true),
            new TrueFalse(R.string.quest113, true),
            new TrueFalse(R.string.quest114, true),
            new TrueFalse(R.string.quest115, true),
            new TrueFalse(R.string.quest116, true),
            new TrueFalse(R.string.quest117, true),
            new TrueFalse(R.string.quest118, true),
            new TrueFalse(R.string.quest119, true),
            new TrueFalse(R.string.quest120, true),
            new TrueFalse(R.string.quest121, true),
            new TrueFalse(R.string.quest122, true),
            new TrueFalse(R.string.quest123, true),
            new TrueFalse(R.string.quest124, true),
            new TrueFalse(R.string.quest125, true),
            new TrueFalse(R.string.quest126, true),
            new TrueFalse(R.string.quest127, true),
            new TrueFalse(R.string.quest128, true),
            new TrueFalse(R.string.quest129, true),
            new TrueFalse(R.string.quest130, true),
...
//TODO Действие при кнопке рестарта.
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent menu = new Intent(SportActivity.this,MainActivity.class);
                startActivity(menu);
                finish();
            }
        });
