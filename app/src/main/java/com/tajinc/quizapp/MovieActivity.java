...
public class MovieActivity extends AppCompatActivity {
    ...
    private TrueFalse[] questions = new TrueFalse[]{
            new TrueFalse(R.string.quest131, true),
            new TrueFalse(R.string.quest132, true),
            new TrueFalse(R.string.quest133, true),
            new TrueFalse(R.string.quest134, true),
            new TrueFalse(R.string.quest135, true),
            new TrueFalse(R.string.quest136, true),
            new TrueFalse(R.string.quest137, true),
            new TrueFalse(R.string.quest138, true),
            new TrueFalse(R.string.quest139, true),
            new TrueFalse(R.string.quest140, true),
    };
...
//TODO Действие при кнопке рестарта.
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent menu = new Intent(MovieActivity.this,MainActivity.class);
                startActivity(menu);
                finish();
            }
        });
