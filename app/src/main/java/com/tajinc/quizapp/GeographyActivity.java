...
public class GeographyActivity extends AppCompatActivity {
    ...
    private TrueFalse[] questions = new TrueFalse[]{
            new TrueFalse(R.string.quest51, true),
            new TrueFalse(R.string.quest52, true),
            new TrueFalse(R.string.quest53, true),
            new TrueFalse(R.string.quest54, true),
            new TrueFalse(R.string.quest55, true),
            new TrueFalse(R.string.quest56, true),
            new TrueFalse(R.string.quest57, true),
            new TrueFalse(R.string.quest58, true),
            new TrueFalse(R.string.quest59, true),
            new TrueFalse(R.string.quest60, true),
            new TrueFalse(R.string.quest61, true),
            new TrueFalse(R.string.quest62, true),
            new TrueFalse(R.string.quest63, true),
            new TrueFalse(R.string.quest64, false),
            new TrueFalse(R.string.quest65, true),
            new TrueFalse(R.string.quest66, true),
            new TrueFalse(R.string.quest67, true),
            new TrueFalse(R.string.quest68, true),
            new TrueFalse(R.string.quest69, true),
            new TrueFalse(R.string.quest70, true),
            new TrueFalse(R.string.quest71, true),
            new TrueFalse(R.string.quest72, true),
            new TrueFalse(R.string.quest73, true),
            new TrueFalse(R.string.quest74, true),
            new TrueFalse(R.string.quest75, true),
            new TrueFalse(R.string.quest76, true),
            new TrueFalse(R.string.quest77, true),
            new TrueFalse(R.string.quest78, true),
            new TrueFalse(R.string.quest79, true),
            new TrueFalse(R.string.quest80, true),
...
//TODO Действие при кнопке рестарта.
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent menu = new Intent(GeographyActivity.this,MainActivity.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    public void dialog() {
        if (run_dialog) {
            final Dialog dialog = new Dialog(GeographyActivity.this);
    ...
    public void HeartOut(){
        ...
        View.OnClickListener onClick = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.btnMenu:
                        Intent intent = new Intent(GeographyActivity.this,MainActivity.class);
