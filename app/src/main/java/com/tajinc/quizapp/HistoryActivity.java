...
public class HistoryActivity extends AppCompatActivity {
    ...
    private TrueFalse[] questions = new TrueFalse[]{
            new TrueFalse(R.string.quest81, true),
            new TrueFalse(R.string.quest82, true),
            new TrueFalse(R.string.quest83, true),
            new TrueFalse(R.string.quest84, true),
            new TrueFalse(R.string.quest85, true),
            new TrueFalse(R.string.quest86, true),
            new TrueFalse(R.string.quest87, false),
            new TrueFalse(R.string.quest88, true),
            new TrueFalse(R.string.quest89, true),
            new TrueFalse(R.string.quest90, true),
            new TrueFalse(R.string.quest91, true),
            new TrueFalse(R.string.quest92, true),
            new TrueFalse(R.string.quest93, true),
            new TrueFalse(R.string.quest94, true),
            new TrueFalse(R.string.quest95, true),
            new TrueFalse(R.string.quest96, true),
            new TrueFalse(R.string.quest97, true),
            new TrueFalse(R.string.quest98, true),
            new TrueFalse(R.string.quest99, true),
            new TrueFalse(R.string.quest100, true),
            new TrueFalse(R.string.quest101, true),
            new TrueFalse(R.string.quest102, true),
            new TrueFalse(R.string.quest103, true),
            new TrueFalse(R.string.quest104, true),
            new TrueFalse(R.string.quest105, true),
            new TrueFalse(R.string.quest106, true),
            new TrueFalse(R.string.quest107, true),
            new TrueFalse(R.string.quest108, true),
            new TrueFalse(R.string.quest109, true),
            new TrueFalse(R.string.quest110, true),
...
//TODO Действие при кнопке рестарта.
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent menu = new Intent(HistoryActivity.this,MainActivity.class);
                startActivity(menu);
                finish();
            }
        });
